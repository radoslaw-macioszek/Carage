	...
	return (
		<div className="offertbar">
			...
			<p className="offertbar__subtitle">
				Jesteśmy pasjonatami motoryzacji i w naszym garazu znajdą się tylko
				szczególne auta, równiez te limitowane.
			</p>
			<div className="offertbar__card">
				<div className="offertbar__card-1 ">
					...
					<div className="offertbar__card-wrapper">
						...
						<p class="offertbar__card-paragraph">
				...
				<div className="offertbar__card-2">
					...
					<div className="offertbar__card-wrapper">
						...
						<p class="offertbar__card-paragraph">
							Brak pomysłu na prezent dla bliskiej Ci osoby? Podaruj juz dziś
							wiatr we włosach i niezapomniane chwile z naszą ofertą. Kartę
							podarunkową otrzymasz w formacie pff na Twoj adres e-mail.
						</p>
					</div>
				</div>
				<div className="offertbar__card-3">
					...
					<div className="offertbar__card-wrapper">
						...
						<p class="offertbar__card-paragraph">
							...
							dla swojga? Wyróznijcie się jeszcze bardziej z naszą ofertą
				...
				<div className="offertbar__card-4">
					...
					<div className="offertbar__card-wrapper">
						...
						<p class="offertbar__card-paragraph">
							...
							które zapadają w pamięci oraz po przejazdzce takze i w sercu
						</p>
					</div>
				</div>
			</div>
